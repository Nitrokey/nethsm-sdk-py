...
from nethsm.client.components.schema import key_set_label
...
__StatusCodeToResponse = typing.TypedDict(
    '__StatusCodeToResponse',
    {
        ...
        '304': typing.Type[response_304.ResponseFor304],
...
_status_code_to_response: __StatusCodeToResponse = {
    ...
    '304': response_304.ResponseFor304,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_label_put(
        self,
        body: typing.Union[
            key_set_label.KeySetLabelDictInput,
            key_set_label.KeySetLabelDict,
        ],
...
class KeysKeyIDLabelPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_label_put = BaseApi._keys_key_id_label_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._keys_key_id_label_put
