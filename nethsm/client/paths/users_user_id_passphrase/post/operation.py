...
from nethsm.client.components.schema import user_passphrase_post_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _users_user_id_passphrase_post(
        self,
        body: typing.Union[
            user_passphrase_post_data.UserPassphrasePostDataDictInput,
            user_passphrase_post_data.UserPassphrasePostDataDict,
        ],
...
class UsersUserIDPassphrasePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    users_user_id_passphrase_post = BaseApi._users_user_id_passphrase_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._users_user_id_passphrase_post
