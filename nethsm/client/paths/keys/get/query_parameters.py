...
from nethsm.client.paths.keys.get.parameters.parameter_0 import schema
from nethsm.client.paths.keys.get.parameters.parameter_1 import schema as schema_2
