...
from nethsm.client.components.schema import tls_key_generate_request_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_tls_generate_post(
        self,
        body: typing.Union[
            tls_key_generate_request_data.TlsKeyGenerateRequestDataDictInput,
            tls_key_generate_request_data.TlsKeyGenerateRequestDataDict,
        ],
        *,
...
class ConfigTlsGeneratePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_tls_generate_post = BaseApi._config_tls_generate_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._config_tls_generate_post
