...
__StatusCodeToResponse = typing.TypedDict(
    '__StatusCodeToResponse',
    {
        ...
        '415': typing.Type[response_415.ResponseFor415],
    }
)
_status_code_to_response: __StatusCodeToResponse = {
    ...
    '415': response_415.ResponseFor415,
}
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_tls_cluster_ca_pem_get(
        self,
        *,
...
class ConfigTlsClusterCaPemGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_tls_cluster_ca_pem_get = BaseApi._config_tls_cluster_ca_pem_get


class ApiForGet(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    get = BaseApi._config_tls_cluster_ca_pem_get
