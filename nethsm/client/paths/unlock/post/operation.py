...
from nethsm.client.components.schema import unlock_request_data
...
class BaseApi(api_client.Api):
    ...
    def _unlock_post(
        self,
        body: typing.Union[
            unlock_request_data.UnlockRequestDataDictInput,
            unlock_request_data.UnlockRequestDataDict,
        ],
        *,
...
class UnlockPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    unlock_post = BaseApi._unlock_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._unlock_post
