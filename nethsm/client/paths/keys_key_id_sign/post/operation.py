...
from nethsm.client.components.schema import sign_request_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_sign_post(
        self,
        body: typing.Union[
            sign_request_data.SignRequestDataDictInput,
            sign_request_data.SignRequestDataDict,
        ],
...
class KeysKeyIDSignPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_sign_post = BaseApi._keys_key_id_sign_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_key_id_sign_post
