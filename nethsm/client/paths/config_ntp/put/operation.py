...
from nethsm.client.components.schema import ntp_config
...
class BaseApi(api_client.Api):
    ...
    def _config_ntp_put(
        self,
        body: typing.Union[
            ntp_config.NtpConfigDictInput,
            ntp_config.NtpConfigDict,
        ],
        *,
...
class ConfigNtpPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_ntp_put = BaseApi._config_ntp_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._config_ntp_put
