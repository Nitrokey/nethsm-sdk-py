...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_restrictions_tags_tag_delete(
        self,
...
class KeysKeyIDRestrictionsTagsTagDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_restrictions_tags_tag_delete = BaseApi._keys_key_id_restrictions_tags_tag_delete


class ApiForDelete(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    delete = BaseApi._keys_key_id_restrictions_tags_tag_delete
