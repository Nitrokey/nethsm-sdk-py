...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_restrictions_tags_tag_put(
        self,
...
class KeysKeyIDRestrictionsTagsTagPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_restrictions_tags_tag_put = BaseApi._keys_key_id_restrictions_tags_tag_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._keys_key_id_restrictions_tags_tag_put
