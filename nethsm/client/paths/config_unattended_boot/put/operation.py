...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_unattended_boot_put(
        self,
        body: typing.Union[
            unattended_boot_config.UnattendedBootConfigDictInput,
            unattended_boot_config.UnattendedBootConfigDict,
        ],
        *,
...
class ConfigUnattendedBootPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_unattended_boot_put = BaseApi._config_unattended_boot_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._config_unattended_boot_put
