...
from nethsm.client.components.schema import cluster_member_add_response
Schema: typing_extensions.TypeAlias = cluster_member_add_response.ClusterMemberAddResponse
