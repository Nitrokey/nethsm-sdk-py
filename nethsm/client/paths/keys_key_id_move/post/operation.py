...
from nethsm.client.components.schema import move_key_request
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_move_post(
        self,
        body: typing.Union[
            move_key_request.MoveKeyRequestDictInput,
            move_key_request.MoveKeyRequestDict,
        ],
...
class KeysKeyIDMovePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_move_post = BaseApi._keys_key_id_move_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_key_id_move_post
