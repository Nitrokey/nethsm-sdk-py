...
from nethsm.client.components.schema import cluster_add_req
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cluster_members_member_id_put(
        self,
        body: typing.Union[
            cluster_add_req.ClusterAddReqDictInput,
            cluster_add_req.ClusterAddReqDict,
        ],
...
class ClusterMembersMemberIDPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    cluster_members_member_id_put = BaseApi._cluster_members_member_id_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._cluster_members_member_id_put
