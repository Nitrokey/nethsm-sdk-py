...
class BaseApi(api_client.Api):
    @typing.overload
    def _cluster_members_member_id_delete(
        self,
...
class ClusterMembersMemberIDDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    cluster_members_member_id_delete = BaseApi._cluster_members_member_id_delete


class ApiForDelete(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    delete = BaseApi._cluster_members_member_id_delete
