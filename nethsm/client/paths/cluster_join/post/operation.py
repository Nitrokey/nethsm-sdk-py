...
from nethsm.client.components.schema import cluster_join_req
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cluster_join_post(
        self,
        body: typing.Union[
            cluster_join_req.ClusterJoinReqDictInput,
            cluster_join_req.ClusterJoinReqDict,
        ],
        *,
...
class ClusterJoinPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    cluster_join_post = BaseApi._cluster_join_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._cluster_join_post
