...
from nethsm.client.components.schema import distinguished_name
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_csr_pem_post(
        self,
        body: typing.Union[
            distinguished_name.DistinguishedNameDictInput,
            distinguished_name.DistinguishedNameDict,
        ],
...
class KeysKeyIDCsrPemPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_csr_pem_post = BaseApi._keys_key_id_csr_pem_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_key_id_csr_pem_post
