...
class BaseApi(api_client.Api):
    @typing.overload
    def _cluster_members_member_id_promote_post(
        self,
...
class ClusterMembersMemberIDPromotePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    cluster_members_member_id_promote_post = BaseApi._cluster_members_member_id_promote_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._cluster_members_member_id_promote_post
