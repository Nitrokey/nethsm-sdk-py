...
from nethsm.client.components.schema import provision_request_data
...
class BaseApi(api_client.Api):
    ...
    def _provision_post(
        self,
        body: typing.Union[
            provision_request_data.ProvisionRequestDataDictInput,
...
class ProvisionPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    provision_post = BaseApi._provision_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._provision_post
