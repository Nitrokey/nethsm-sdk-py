...
from nethsm.client.paths.system_update.post.request_body.content.application_octet_stream import schema
...
class SystemUpdatePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    system_update_post = BaseApi._system_update_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._system_update_post
