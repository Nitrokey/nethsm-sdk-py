...
from nethsm.client.components.schema import decrypt_request_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_decrypt_post(
        self,
        body: typing.Union[
            decrypt_request_data.DecryptRequestDataDictInput,
            decrypt_request_data.DecryptRequestDataDict,
        ],
...
class KeysKeyIDDecryptPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_decrypt_post = BaseApi._keys_key_id_decrypt_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_key_id_decrypt_post
