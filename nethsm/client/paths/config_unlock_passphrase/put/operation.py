...
from nethsm.client.components.schema import unlock_passphrase_config
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_unlock_passphrase_put(
        self,
        body: typing.Union[
            unlock_passphrase_config.UnlockPassphraseConfigDictInput,
            unlock_passphrase_config.UnlockPassphraseConfigDict,
        ],
        *,
...
class ConfigUnlockPassphrasePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_unlock_passphrase_put = BaseApi._config_unlock_passphrase_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._config_unlock_passphrase_put
