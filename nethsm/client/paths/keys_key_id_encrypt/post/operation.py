...
from nethsm.client.components.schema import encrypt_request_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_key_id_encrypt_post(
        self,
        body: typing.Union[
            encrypt_request_data.EncryptRequestDataDictInput,
            encrypt_request_data.EncryptRequestDataDict,
        ],
...
class KeysKeyIDEncryptPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    keys_key_id_encrypt_post = BaseApi._keys_key_id_encrypt_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_key_id_encrypt_post
