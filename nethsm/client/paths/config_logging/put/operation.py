...
from nethsm.client.components.schema import logging_config
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_logging_put(
        self,
        body: typing.Union[
            logging_config.LoggingConfigDictInput,
...
class ConfigLoggingPut(BaseApi):
    ...
    config_logging_put = BaseApi._config_logging_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._config_logging_put
