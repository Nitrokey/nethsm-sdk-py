...
from nethsm.client.components.schema import backup_passphrase_config
...
class BaseApi(api_client.Api):
    @typing.overload
    def _config_backup_passphrase_put(
        self,
        body: typing.Union[
            backup_passphrase_config.BackupPassphraseConfigDictInput,
            backup_passphrase_config.BackupPassphraseConfigDict,
        ],
        *,
...
class ConfigBackupPassphrasePut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    config_backup_passphrase_put = BaseApi._config_backup_passphrase_put


class ApiForPut(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    put = BaseApi._config_backup_passphrase_put
