...
from nethsm.client.components.schema import random_request_data
...
class BaseApi(api_client.Api):
    ...
    def _random_post(
        self,
        body: typing.Union[
            random_request_data.RandomRequestDataDictInput,
            random_request_data.RandomRequestDataDict,
        ],
        *,
...
class RandomPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    random_post = BaseApi._random_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._random_post
