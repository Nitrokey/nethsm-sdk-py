...
from nethsm.client.components.schema import key_generate_request_data
...
class BaseApi(api_client.Api):
    @typing.overload
    def _keys_generate_post(
        self,
        body: typing.Union[
            key_generate_request_data.KeyGenerateRequestDataDictInput,
            key_generate_request_data.KeyGenerateRequestDataDict,
        ],
        *,
...
class KeysGeneratePost(BaseApi):
    ...
    keys_generate_post = BaseApi._keys_generate_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._keys_generate_post
