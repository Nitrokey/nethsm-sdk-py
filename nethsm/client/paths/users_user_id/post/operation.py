...
from nethsm.client.components.schema import user_post_data
...
__StatusCodeToResponse = typing.TypedDict(
    ...
    {
        '201': typing.Type[response_201.ResponseFor201],
...
_status_code_to_response: __StatusCodeToResponse = {
    '201': response_201.ResponseFor201,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _users_user_id_post(
        self,
        body: typing.Union[
            user_post_data.UserPostDataDictInput,
            user_post_data.UserPostDataDict,
        ],
...
class UsersUserIDPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId.snakeCase fn names
    users_user_id_post = BaseApi._users_user_id_post


class ApiForPost(BaseApi):
    # this class is used by api classes that refer to endpoints by path and http method names
    post = BaseApi._users_user_id_post
