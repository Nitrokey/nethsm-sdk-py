...
SecurityIndexInfoOptional = typing.TypedDict(
    'SecurityIndexInfoOptional',
    {
        ...
        "paths//cluster/members/{MemberID}/delete/security": typing.Literal[0],
        "paths//cluster/members/{MemberID}/put/security": typing.Literal[0],
        "paths//cluster/members/{MemberID}/promote/post/security": typing.Literal[0],
        ...
        "paths//config/ntp/get/security": typing.Literal[0],
        "paths//config/ntp/put/security": typing.Literal[0],
        ...
        "paths//config/tls/cluster-ca.pem/get/security": typing.Literal[0],
        "paths//config/tls/cluster-ca.pem/put/security": typing.Literal[0],
        ...
        "paths//keys/{KeyID}/label/delete/security": typing.Literal[0],
        "paths//keys/{KeyID}/label/put/security": typing.Literal[0],
        "paths//keys/{KeyID}/move/post/security": typing.Literal[0],
        ...
        "paths//keys/{KeyPrefix}*/get/security": typing.Literal[0],
        "paths//lock/post/security": typing.Literal[0],
        "paths//metrics/get/security": typing.Literal[0],
        "paths//namespaces/get/security": typing.Literal[0],
        "paths//namespaces/{NamespaceID}/delete/security": typing.Literal[0],
        "paths//namespaces/{NamespaceID}/put/security": typing.Literal[0],
        ...
        "paths//system/restore/post/security": typing.Literal[0, 1],
        "paths//system/shutdown/post/security": typing.Literal[0, 1],
        ...
        "paths//users/{UserID}/post/security": typing.Literal[0],
...
class ApiConfiguration(object):
    ...
    def get_security_requirement_object(
        ...
        key_prefix: typing.Literal[
            ...
            "paths//cluster/members/{MemberID}/delete/security",
            "paths//cluster/members/{MemberID}/put/security",
            "paths//cluster/members/{MemberID}/promote/post/security",
            ...
            "paths//config/ntp/get/security",
            "paths//config/ntp/put/security",
            ...
            "paths//config/tls/cluster-ca.pem/get/security",
            "paths//config/tls/cluster-ca.pem/put/security",
            ...
            "paths//health/diagnose/get/security",
            ...
            "paths//keys/{KeyID}/label/delete/security",
            "paths//keys/{KeyID}/label/put/security",
            "paths//keys/{KeyID}/move/post/security",
            ...
            "paths//keys/{KeyPrefix}*/get/security",
            "paths//lock/post/security",
            "paths//metrics/get/security",
            "paths//namespaces/get/security",
            ...
            "paths//users/{UserID}/post/security",
