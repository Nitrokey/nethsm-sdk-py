...
Properties = typing.TypedDict(
    'Properties',
    {
        ...
        "currentPassphrase": typing.Type[passphrase.Passphrase],
    }
)
...
class UnlockPassphraseConfigDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        return UnlockPassphraseConfig.validate(used_arg_, configuration=configuration_)
...
UnlockPassphraseConfigDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class UnlockPassphraseConfig(
    schemas.Schema[UnlockPassphraseConfigDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: UnlockPassphraseConfigDict
        }
    )
