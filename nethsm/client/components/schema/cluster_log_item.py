    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        for key_, val in (
            ...
            arg_[key_] = val
        arg_.update(kwargs)
        used_arg_ = typing.cast(ClusterLogItemDictInput, arg_)
        return ClusterLogItem.validate(used_arg_, configuration=configuration_)
    
    @staticmethod
    def from_dict_(
        arg: typing.Union[
            ClusterLogItemDictInput,
            ClusterLogItemDict
        ],
...
ClusterLogItemDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class ClusterLogItem(
    schemas.Schema[ClusterLogItemDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: ClusterLogItemDict
        }
    )
