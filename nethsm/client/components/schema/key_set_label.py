...
class KeySetLabelDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(KeySetLabelDictInput, arg_)
        return KeySetLabel.validate(used_arg_, configuration=configuration_)
    
    @staticmethod
    def from_dict_(
        arg: typing.Union[
            KeySetLabelDictInput,
            KeySetLabelDict
        ],
        configuration: typing.Optional[schema_configuration.SchemaConfiguration] = None
    ) -> KeySetLabelDict:
        return KeySetLabel.validate(arg, configuration=configuration)
...
KeySetLabelDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class KeySetLabel(
    schemas.Schema[KeySetLabelDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: KeySetLabelDict
        }
    )
