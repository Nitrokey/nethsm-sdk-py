...
class BackupPassphraseConfigDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        return BackupPassphraseConfig.validate(used_arg_, configuration=configuration_)
...
BackupPassphraseConfigDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class BackupPassphraseConfig(
    schemas.Schema[BackupPassphraseConfigDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: BackupPassphraseConfigDict
        }
    )
