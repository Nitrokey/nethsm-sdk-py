...
class UnlockRequestDataDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(UnlockRequestDataDictInput, arg_)
        return UnlockRequestData.validate(used_arg_, configuration=configuration_)
...
UnlockRequestDataDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class UnlockRequestData(
    schemas.Schema[UnlockRequestDataDict, tuple]
):
