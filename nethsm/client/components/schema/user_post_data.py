...
class UserPostDataDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(UserPostDataDictInput, arg_)
        return UserPostData.validate(used_arg_, configuration=configuration_)
    
    @staticmethod
    def from_dict_(
        arg: typing.Union[
            UserPostDataDictInput,
            UserPostDataDict
        ],
...
UserPostDataDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class UserPostData(
    schemas.Schema[UserPostDataDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: UserPostDataDict
        }
    )
