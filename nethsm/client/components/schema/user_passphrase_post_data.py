...
class UserPassphrasePostDataDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(UserPassphrasePostDataDictInput, arg_)
        return UserPassphrasePostData.validate(used_arg_, configuration=configuration_)
    ...
    def from_dict_(
        ...
        return UserPassphrasePostData.validate(arg, configuration=configuration)
...
UserPassphrasePostDataDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class UserPassphrasePostData(
    schemas.Schema[UserPassphrasePostDataDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: UserPassphrasePostDataDict
        }
    )
