...
Properties = typing.TypedDict(
    'Properties',
    {
        "decrypted": typing.Type[base64.Base64],
    }
)


class DecryptDataDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(DecryptDataDictInput, arg_)
        return DecryptData.validate(used_arg_, configuration=configuration_)
    ...
    def from_dict_(
        ...
        return DecryptData.validate(arg, configuration=configuration)
    
    @property
    def decrypted(self) -> str:
        return typing.cast(
            str,
            self.__getitem__("decrypted")
        )
    
    def get_additional_property_(self, name: str) -> typing.Union[schemas.OUTPUT_BASE_TYPES, schemas.Unset]:
        schemas.raise_if_key_known(name, self.__required_keys__, self.__optional_keys__)
        return self.get(name, schemas.unset)
DecryptDataDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class DecryptData(
    schemas.Schema[DecryptDataDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: DecryptDataDict
        }
    )
