...
from nethsm.client.components.schema import cluster_log_item


class ClusterLogListTuple(
    typing.Tuple[
        cluster_log_item.ClusterLogItemDict,
        ...
    ]
):

    def __new__(cls, arg: typing.Union[ClusterLogListTupleInput, ClusterLogListTuple], configuration: typing.Optional[schema_configuration.SchemaConfiguration] = None):
        return ClusterLogList.validate(arg, configuration=configuration)
ClusterLogListTupleInput = typing.Union[
    typing.List[
        typing.Union[
            cluster_log_item.ClusterLogItemDictInput,
            cluster_log_item.ClusterLogItemDict,
        ],
    ],
    typing.Tuple[
...
class ClusterLogList(
    schemas.Schema[schemas.immutabledict, ClusterLogListTuple]
):
