...
from nethsm.client.components.schema import system_state
Properties = typing.TypedDict(
    'Properties',
    {
        "state": typing.Type[system_state.SystemState],
    }
)


class HealthStateDataDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(HealthStateDataDictInput, arg_)
        return HealthStateData.validate(used_arg_, configuration=configuration_)
...
HealthStateDataDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class HealthStateData(
    schemas.Schema[HealthStateDataDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: HealthStateDataDict
        }
    )
