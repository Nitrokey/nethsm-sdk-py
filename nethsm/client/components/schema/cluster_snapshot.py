...
Hash: typing_extensions.TypeAlias = schemas.IntSchema
Revision: typing_extensions.TypeAlias = schemas.IntSchema
TotalKey: typing_extensions.TypeAlias = schemas.IntSchema
TotalSize: typing_extensions.TypeAlias = schemas.IntSchema
Version: typing_extensions.TypeAlias = schemas.StrSchema
Properties = typing.TypedDict(
    'Properties',
    {
        "hash": typing.Type[Hash],
        "revision": typing.Type[Revision],
        "totalKey": typing.Type[TotalKey],
        "totalSize": typing.Type[TotalSize],
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        for key_, val in (
            ...
            arg_[key_] = val
        arg_.update(kwargs)
        used_arg_ = typing.cast(ClusterSnapshotDictInput, arg_)
        return ClusterSnapshot.validate(used_arg_, configuration=configuration_)
    
    @staticmethod
    def from_dict_(
        arg: typing.Union[
            ClusterSnapshotDictInput,
            ClusterSnapshotDict
        ],
...
ClusterSnapshotDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class ClusterSnapshot(
    schemas.Schema[ClusterSnapshotDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: ClusterSnapshotDict
        }
    )
