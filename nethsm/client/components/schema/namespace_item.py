...
class NamespaceItemDict(schemas.immutabledict[str, schemas.OUTPUT_BASE_TYPES]):
    ...
    def __new__(
        ...
        **kwargs: schemas.INPUT_TYPES_ALL,
        ...
        arg_.update(kwargs)
        used_arg_ = typing.cast(NamespaceItemDictInput, arg_)
        return NamespaceItem.validate(used_arg_, configuration=configuration_)
    
    @staticmethod
    def from_dict_(
        arg: typing.Union[
            NamespaceItemDictInput,
            NamespaceItemDict
        ],
        configuration: typing.Optional[schema_configuration.SchemaConfiguration] = None
    ) -> NamespaceItemDict:
        return NamespaceItem.validate(arg, configuration=configuration)
...
NamespaceItemDictInput = typing.Mapping[str, schemas.INPUT_TYPES_ALL]


@dataclasses.dataclass(frozen=True)
class NamespaceItem(
    schemas.Schema[NamespaceItemDict, tuple]
):
    ...
    type_to_output_cls: typing.Mapping[
        ...
        default_factory=lambda: {
            schemas.immutabledict: NamespaceItemDict
        }
    )
